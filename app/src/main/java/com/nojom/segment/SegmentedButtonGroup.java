...
public class SegmentedButtonGroup extends LinearLayout {
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        animateSelectorDuration = typedArray.getInt(R.styleable.SegmentedButtonGroup_sbg_animateSelectorDuration, 900);
        ...
        Drawable backgroundDrawable = typedArray.getDrawable(R.styleable.SegmentedButtonGroup_sbg_backgroundDrawable);
        Drawable selectorBackgroundDrawable = typedArray.getDrawable(R.styleable.SegmentedButtonGroup_sbg_selectorBackgroundDrawable);
    ...
    private void initInterpolations() {
        ArrayList<Class> interpolatorList = new ArrayList<Class>() {{
            add(androidx.interpolator.view.animation.FastOutSlowInInterpolator.class);
            add(android.view.animation.BounceInterpolator.class);
            add(android.view.animation.LinearInterpolator.class);
            add(android.view.animation.DecelerateInterpolator.class);
            add(android.view.animation.CycleInterpolator.class);
            add(android.view.animation.AnticipateInterpolator.class);
            add(android.view.animation.AccelerateDecelerateInterpolator.class);
            add(android.view.animation.AccelerateInterpolator.class);
            add(android.view.animation.AnticipateOvershootInterpolator.class);
            add(androidx.interpolator.view.animation.FastOutLinearInInterpolator.class);
            add(androidx.interpolator.view.animation.LinearOutSlowInInterpolator.class);
            add(android.view.animation.OvershootInterpolator.class);
        }};
     ...
     *                             Ex: {@link androidx.interpolator.view.animation.FastOutSlowInInterpolator}, {@link android.view.animation.BounceInterpolator}, {@link android.view.animation.LinearInterpolator}
     */
    ...
    private void toggle(int position, int duration, boolean isToggledByTouch) {
        ...
        animator.addUpdateListener(animation -> {
            ...
            int position1 = (int) animatedValue;
            float positionOffset = animatedValue - position1;

            animateViews(position1, positionOffset);
