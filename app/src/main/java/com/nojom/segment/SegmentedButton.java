...
public class SegmentedButton extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        language = Preferences.readString(context, PREF_SELECTED_LANGUAGE, "en").toString();
    ...
    private void initText() {
        ...
        if (language.equals("ar")){
            mStaticLayout = new StaticLayout(text, mTextPaint, width, Layout.Alignment.ALIGN_CENTER, 1.0f, 0, false);
            mStaticLayoutOverlay = new StaticLayout(text, mTextPaint, width, Layout.Alignment.ALIGN_CENTER, 1.0f, 0, false);
        }
        else{
    ...
    private void measureTextWidth(int width) {
        ...
        if (language.equals("ar")){
            mStaticLayout = new StaticLayout(text, mTextPaint, textWidth, Layout.Alignment.ALIGN_CENTER, 1.0f, 0, false);
            mStaticLayoutOverlay = new StaticLayout(text, mTextPaint, textWidth, Layout.Alignment.ALIGN_CENTER, 1.0f, 0, false);
        }
        else{
    ...
    private int drawableTintOnSelection, textColorOnSelection, textColor, rippleColor, buttonWidth,
            drawable, drawableTint, drawableWidth, drawableHeight, drawablePadding, selectorColor;
    private boolean hasTextColorOnSelection, hasRipple, hasWidth, hasWeight, hasDrawableTintOnSelection,
            hasDrawableWidth, hasDrawableHeight, hasDrawableTint, hasTextTypefacePath, hasSelectorColor;
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        selectorColor = ta.getColor(R.styleable.SegmentedButton_sb_selectorColor, 0);
        hasSelectorColor = ta.hasValue(R.styleable.SegmentedButton_sb_selectorColor);
