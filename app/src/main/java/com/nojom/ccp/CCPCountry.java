...
public class CCPCountry implements Comparable<CCPCountry> {
    ...
    public static List<CCPCountry> getLibraryMasterCountriesEnglish() {
        ...
        countries.add(new CCPCountry("ad", "376", "Andorra", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ae", "971", "United Arab Emirates (UAE)", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("af", "93", "Afghanistan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ag", "1268", "Antigua and Barbuda", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ai", "1264", "Anguilla", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("al", "355", "Albania", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("am", "374", "Armenia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ao", "244", "Angola", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("aq", "672", "Antarctica", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ar", "54", "Argentina", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("as", "1684", "American Samoa", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("at", "43", "Austria", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("au", "61", "Australia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("aw", "297", "Aruba", DEFAULT_FLAG_RES, false));
//        countries.add(new CCPCountry("az", "358", "Aland Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("az", "994", "Azerbaijan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ba", "387", "Bosnia And Herzegovina", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bb", "1246", "Barbados", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bd", "880", "Bangladesh", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("be", "32", "Belgium", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bf", "226", "Burkina Faso", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bg", "359", "Bulgaria", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bh", "973", "Bahrain", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bi", "257", "Burundi", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bj", "229", "Benin", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bl", "590", "Saint Barthélemy", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bm", "1441", "Bermuda", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bn", "673", "Brunei Darussalam", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bo", "591", "Bolivia, Plurinational State Of", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("br", "55", "Brazil", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bs", "1242", "Bahamas", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bt", "975", "Bhutan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bw", "267", "Botswana", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("by", "375", "Belarus", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("bz", "501", "Belize", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ca", "1", "Canada", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cc", "61", "Cocos (keeling) Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cd", "243", "Congo, The Democratic Republic Of The", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cf", "236", "Central African Republic", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cg", "242", "Congo", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ch", "41", "Switzerland", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ci", "225", "Côte D'ivoire", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ck", "682", "Cook Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cl", "56", "Chile", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cm", "237", "Cameroon", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cn", "86", "China", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("co", "57", "Colombia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cr", "506", "Costa Rica", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cu", "53", "Cuba", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cv", "238", "Cape Verde", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cw", "599", "Curacao", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cx", "61", "Christmas Island", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cy", "357", "Cyprus", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("cz", "420", "Czech Republic", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("de", "49", "Germany", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("dj", "253", "Djibouti", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("dk", "45", "Denmark", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("dm", "1767", "Dominica", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("do", "1809", "Dominican Republic", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("do", "1829", "Dominican Republic", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("do", "1849", "Dominican Republic", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("dz", "213", "Algeria", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ec", "593", "Ecuador", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ee", "372", "Estonia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("eg", "20", "Egypt", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("er", "291", "Eritrea", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("es", "34", "Spain", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("et", "251", "Ethiopia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("fi", "358", "Finland", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("fj", "679", "Fiji", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("fk", "500", "Falkland Islands (malvinas)", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("fm", "691", "Micronesia, Federated States Of", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("fo", "298", "Faroe Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("fr", "33", "France", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ga", "241", "Gabon", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gb", "44", "United Kingdom", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gd", "1473", "Grenada", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ge", "995", "Georgia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gf", "594", "French Guyana", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gh", "233", "Ghana", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gi", "350", "Gibraltar", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gl", "299", "Greenland", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gm", "220", "Gambia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gn", "224", "Guinea", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gp", "450", "Guadeloupe", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gq", "240", "Equatorial Guinea", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gr", "30", "Greece", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gt", "502", "Guatemala", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gu", "1671", "Guam", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gw", "245", "Guinea-bissau", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("gy", "592", "Guyana", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("hk", "852", "Hong Kong", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("hn", "504", "Honduras", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("hr", "385", "Croatia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ht", "509", "Haiti", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("hu", "36", "Hungary", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("id", "62", "Indonesia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ie", "353", "Ireland", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("il", "972", "Israel", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("im", "44", "Isle Of Man", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("is", "354", "Iceland", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("in", "91", "India", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("io", "246", "British Indian Ocean Territory", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("iq", "964", "Iraq", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ir", "98", "Iran, Islamic Republic Of", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("it", "39", "Italy", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("je", "44", "Jersey ", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("jm", "1876", "Jamaica", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("jo", "962", "Jordan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("jp", "81", "Japan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ke", "254", "Kenya", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("kg", "996", "Kyrgyzstan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("kh", "855", "Cambodia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ki", "686", "Kiribati", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("km", "269", "Comoros", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("kn", "1869", "Saint Kitts and Nevis", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("kp", "850", "North Korea", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("kr", "82", "South Korea", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("kw", "965", "Kuwait", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ky", "1345", "Cayman Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("kz", "7", "Kazakhstan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("la", "856", "Lao People's Democratic Republic", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("lb", "961", "Lebanon", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("lc", "1758", "Saint Lucia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("li", "423", "Liechtenstein", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("lk", "94", "Sri Lanka", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("lr", "231", "Liberia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ls", "266", "Lesotho", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("lt", "370", "Lithuania", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("lu", "352", "Luxembourg", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("lv", "371", "Latvia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ly", "218", "Libya", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ma", "212", "Morocco", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mc", "377", "Monaco", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("md", "373", "Moldova, Republic Of", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("me", "382", "Montenegro", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mf", "590", "Saint Martin", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mg", "261", "Madagascar", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mh", "692", "Marshall Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mk", "389", "Macedonia, The Former Yugoslav Republic Of", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ml", "223", "Mali", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mm", "95", "Myanmar", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mn", "976", "Mongolia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mo", "853", "Macao", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mp", "1670", "Northern Mariana Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mq", "596", "Martinique", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mr", "222", "Mauritania", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ms", "1664", "Montserrat", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mt", "356", "Malta", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mu", "230", "Mauritius", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mv", "960", "Maldives", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mw", "265", "Malawi", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mx", "52", "Mexico", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("my", "60", "Malaysia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("mz", "258", "Mozambique", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("na", "264", "Namibia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("nc", "687", "New Caledonia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ne", "227", "Niger", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("nf", "672", "Norfolk Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ng", "234", "Nigeria", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ni", "505", "Nicaragua", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("nl", "31", "Netherlands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("no", "47", "Norway", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("np", "977", "Nepal", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("nr", "674", "Nauru", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("nu", "683", "Niue", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("nz", "64", "New Zealand", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("om", "968", "Oman", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pa", "507", "Panama", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pe", "51", "Peru", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pf", "689", "French Polynesia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pg", "675", "Papua New Guinea", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ph", "63", "Philippines", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pk", "92", "Pakistan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pl", "48", "Poland", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pm", "508", "Saint Pierre And Miquelon", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pn", "870", "Pitcairn", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pr", "1", "Puerto Rico", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ps", "970", "Palestine", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pt", "351", "Portugal", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("pw", "680", "Palau", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("py", "595", "Paraguay", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("qa", "974", "Qatar", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("re", "262", "Réunion", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ro", "40", "Romania", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("rs", "381", "Serbia", DEFAULT_FLAG_RES, false));
//        countries.add(new CCPCountry("ru", "7", "Russian Federation", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("rw", "250", "Rwanda", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sa", "966", "Saudi Arabia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sb", "677", "Solomon Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sc", "248", "Seychelles", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sd", "249", "Sudan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("se", "46", "Sweden", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sg", "65", "Singapore", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sh", "290", "Saint Helena, Ascension And Tristan Da Cunha", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("si", "386", "Slovenia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sk", "421", "Slovakia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sl", "232", "Sierra Leone", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sm", "378", "San Marino", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sn", "221", "Senegal", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("so", "252", "Somalia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sr", "597", "Suriname", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("st", "239", "Sao Tome And Principe", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sv", "503", "El Salvador", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sx", "1721", "Sint Maarten", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sy", "963", "Syrian Arab Republic", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("sz", "268", "Swaziland", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tc", "1649", "Turks and Caicos Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("td", "235", "Chad", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tg", "228", "Togo", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("th", "66", "Thailand", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tj", "992", "Tajikistan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tk", "690", "Tokelau", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tl", "670", "Timor-leste", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tm", "993", "Turkmenistan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tn", "216", "Tunisia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("to", "676", "Tonga", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tr", "90", "Turkey", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tt", "868", "Trinidad & Tobago", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tv", "688", "Tuvalu", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tw", "886", "Taiwan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("tz", "255", "Tanzania, United Republic Of", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ua", "380", "Ukraine", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ug", "256", "Uganda", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("us", "1", "United States", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("uy", "598", "Uruguay", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("uz", "998", "Uzbekistan", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("va", "379", "Holy See (vatican City State)", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("vc", "1784", "Saint Vincent & The Grenadines", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ve", "58", "Venezuela, Bolivarian Republic Of", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("vg", "1284", "British Virgin Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("vi", "1", "US Virgin Islands", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("vn", "84", "Viet Nam", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("vu", "678", "Vanuatu", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("wf", "681", "Wallis And Futuna", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ws", "685", "Samoa", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("xk", "383", "Kosovo", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("ye", "967", "Yemen", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("yt", "262", "Mayotte", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("za", "27", "South Africa", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("zm", "260", "Zambia", DEFAULT_FLAG_RES, false));
        countries.add(new CCPCountry("zw", "263", "Zimbabwe", DEFAULT_FLAG_RES, false));
        return countries;
    }
