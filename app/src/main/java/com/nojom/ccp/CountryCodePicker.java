...
public class CountryCodePicker extends RelativeLayout {
    ...
    void setSelectedCountry(CCPCountry selectedCCPCountry) {
        ...
        if (!showFlag && displayText.length() == 0) {
            displayText += "+" + selectedCCPCountry.getPhoneCode();
            textView_selectedCountry.setText(displayText);
        }
        ...
        if (selectedCCPCountry != null)
            imageViewFlag.setImageResource(selectedCCPCountry.getFlag(selectedCCPCountry));
    ...
    public boolean isValidFullNumber() {
        try {
            if (getEditText_registeredCarrierNumber() != null && getEditText_registeredCarrierNumber().getText().length() != 0) {
                ...
                Utils.toastMessage((Activity) context, "No editText for Carrier number found.");
                return false;
            } else {
                return false;
            }
