...
public class ContractRateFragment extends BaseFragment {

    private ContractRateFragmentVM projectRateFragmentVM;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        projectRateFragmentVM = new ContractRateFragmentVM(Task24Application.getActivity(), binding, this);
