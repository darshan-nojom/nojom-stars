...
import com.nojom.databinding.DialogCustomOptionBinding;
...
public class CustomGigViewlActivity extends BaseActivity {
    private ActivityGigCustomViewBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_gig_custom_view);
...
//        binding.relContinue.setOnClickListener(v -> startActivity(new Intent(this, UpgradeGigsActivity.class)));
    ...
    private void addDeadlineView() {
        if (deadlineList != null && deadlineList.size() > 0) {
            ...
            final String[] value = {deadlineList.get(position[0]).value + " " + (deadlineList.get(position[0]).type == 2 ? "Days" : "Hours")};
