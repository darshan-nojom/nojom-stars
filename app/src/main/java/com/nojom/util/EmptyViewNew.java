 ...
 */
class EmptyViewNew extends View {

    public EmptyViewNew(Context context) {
        super(context);
    }

    public EmptyViewNew(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public EmptyViewNew(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
