...
public class SegmentedButtonNew extends View
{
    ...
    private SegmentedButtonNew leftButton;
    private SegmentedButtonNew rightButton;
...
//    private codetail.graphics.drawables.RippleDrawable rippleDrawable;
    ...
    public SegmentedButtonNew(Context context)
    {
        super(context);
        init(context, null);
    }

    public SegmentedButtonNew(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }

    public SegmentedButtonNew(Context context, AttributeSet attrs, int defStyleAttr)
    {
...
//            rippleDrawable.setState(getDrawableState());
    ...
    void setLeftButton(SegmentedButtonNew leftButton)
    {
     ...
     */
    @SuppressWarnings("SameParameterValue")
    void setRightButton(SegmentedButtonNew rightButton)
    {
...
//            rippleDrawable = null;
    ...
    {
        void onVisibilityChanged(SegmentedButtonNew button, int visibility);
    }
