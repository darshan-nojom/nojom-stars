...
public class SubmitGigFilesAdapter extends RecyclerView.Adapter<SubmitGigFilesAdapter.SimpleViewHolder> {
    ...
    public SubmitGigFilesAdapter(Context context, ArrayList<ProjectByID.FileList> objects,String filePath) {
...
//            String url = activity.getClientAttachmentUrl() + attachments.fileName;
