...
public class MyStoresAdapter extends RecyclerView.Adapter<MyStoresAdapter.SimpleViewHolder> implements ReOrderStoreMoveCallback.ItemTouchHelperContract {
    ...
    public MyStoresAdapter(BaseActivity context, OnClickListener listener, UpdateSwipeListener updatelistener) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemStoreBinding itemAccountBinding =
...
//                context.startActivity(i);
    ...
    public interface OnClickListener {
        void onClickShow(GetStores.Data companies, int pos);
        void onClickMenu(GetStores.Data companies, int pos, View view, int loc);
    }

    private UpdateSwipeListener onClickPlatformListener;

    public interface UpdateSwipeListener {
        void onSwipeSuccess(List<GetStores.Data> mDatasetFiltered);
