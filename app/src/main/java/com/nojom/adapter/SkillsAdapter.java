...
public class SkillsAdapter extends RecyclerView.Adapter<SkillsAdapter.SimpleViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemSkillClick(boolean isEmlpoyment, String tag);
    }

    public SkillsAdapter(Context context, ArrayList<Skill> objects, OnItemClickListener onItemClickListener, boolean isEmployement) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemSkillsBinding itemBinding =
                ItemSkillsBinding.inflate(layoutInflater, parent, false);
        ...
        SimpleViewHolder(ItemSkillsBinding itemView) {
            ...
            itemView.getRoot().setOnClickListener(v -> {
                if (onItemClickListener != null) {
                    onItemClickListener.onItemSkillClick(isEmployment, getSELECTED_TAG());
                }
            });
        }
    }
